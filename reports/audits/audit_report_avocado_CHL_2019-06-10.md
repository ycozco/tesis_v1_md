...
**Código Único del Reporte (UUID):** 304c3a76-7e1f-40ce-81cc-3eef458f9cb9
...
*   **Semana de Análisis (semana t+1):** 2019-06-10
*   **Puntuación del Ensemble PyOD:** 0.9591
...
*   **Factores que incrementan la predicción:** volume_rolling_max_8 (+0.275), price_rolling_min_52 (+0.087), volume_rolling_max_52 (+0.064), volume_rolling_std_8 (+0.057), volume_rolling_std_4 (+0.055)
*   **Factores que reducen la predicción:** price_rolling_mean_4 (-0.139), price_lag_1 (-0.135), price_rolling_min_4 (-0.104), price_rolling_max_4 (-0.092), month_cos (-0.079)

### B. Atribución sobre el Volumen de Exportación
*   **Factores que incrementan la predicción:** price_lag_1 (+0.088), price_rolling_max_8 (+0.040), volume_rolling_std_52 (+0.038), volume_pct_change_4 (+0.014), volume_rolling_mean_52 (+0.012)
*   **Factores que reducen la predicción:** price_age_weeks (-0.208), volume_rolling_mean_4 (-0.038), volume_rolling_max_4 (-0.031), price_rolling_std_4 (-0.017), price_lag_2 (-0.011)
...
*   **ID de Alerta de Origen:** 6351ff463a29844a
