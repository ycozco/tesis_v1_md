...
def main():
    ...
    default_docx = output_dir / "tesis.docx"
    default_pdf = output_dir / "tesis.pdf"
    
    # Nombres de salida con fecha
    dated_docx = output_dir / f"tesis_{today_str}.docx"
    dated_pdf = output_dir / f"tesis_{today_str}.pdf"
