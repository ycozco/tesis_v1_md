...
| `entregable-1.md` | Cap. I y II base previa | ✅ Útil como antecedente de redacción |
| `tesis-v2.md` | Versión anterior financiera/fraude | ⚠️ Desfasada; conservar solo como referencia histórica |
| `mejora-continua-plan.md` | Plan PDCA por ciclos | ✅ Útil para iteración |

### Lo que FALTA y es el objeto de este plan
1. Ajustar el lenguaje financiero residual en `tesis-v2.md` y partes heredadas.
...
El Capítulo I de `entregable-1.md` es sólido. Los únicos refinamientos son:
...
- Evaluación de texto generado: ROUGE (Lin, 2004), BLEU (Papineni et al., 2002) — referencias de tesis-v2
